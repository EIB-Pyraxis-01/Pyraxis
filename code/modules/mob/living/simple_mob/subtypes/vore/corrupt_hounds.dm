...
/mob/living/simple_mob/vore/aggressive/corrupthound
	...
	loot_list = list(/obj/item/borg/upgrade/basic/syndicate = 6, /obj/item/borg/upgrade/basic/vtec = 6, /obj/item/material/knife/ritual = 6) // , /obj/item/disk/nifsoft/compliance = 6) PY edit - Nif removal
