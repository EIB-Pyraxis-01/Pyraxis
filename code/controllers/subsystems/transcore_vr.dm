...
/datum/controller/subsystem/transcore/proc/m_backup(datum/mind/mind, nif /* PY edit - Nif removal obj/item/nif/nif */, one_time = FALSE, database_key)
...
/datum/transcore_db/proc/m_backup(datum/mind/mind, nif /* PY edit - Nif removal obj/item/nif/nif */, one_time = FALSE)
	ASSERT(mind)
